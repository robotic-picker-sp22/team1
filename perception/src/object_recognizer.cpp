...
namespace perception
{
                                   ...
                                   double *confidence)
  {
    ...
    // std::cout << "dataset size is " << dataset_.size() << std::endl;
    for (size_t i = 0; i < dataset_.size(); ++i)
    {
      ...
      // std::cout << "candidate " << dataset_[i].object_name << " " << distance << std::endl;
    ...
    *confidence = 1 - min_distance / (min_distance + second_min_distance);
    ...
    // std::cout << "object name is " << *name << " with confidence " << *confidence << std::endl;
  }
} // namespace perception